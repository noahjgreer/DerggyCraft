...
public class SoundSystem {
    ...
    public SoundSystem(Class class_) {
        if (this.logger == null) {
            this.logger = new SoundSystemLogger();
            SoundSystemConfig.setLogger(this.logger);
        }
    ...
    protected void init(Class class_) {
        this.message("", 0);
    ...
    public void fadeOutIn(String string, String string2, long l, long m) {
        this.CommandQueue(new CommandObject(8, string, new FilenameURL(string2), l, m));
        this.commandThread.interrupt();
    }

    public void fadeOutIn(String string, URL uRL, String string2, long l, long m) {
        this.CommandQueue(new CommandObject(8, string, new FilenameURL(uRL, string2), l, m));
        this.commandThread.interrupt();
    }
    ...
    public void newSource(boolean bl, String string, String string2, boolean bl2, float f, float g, float h, int i, float j) {
        this.CommandQueue(new CommandObject(10, bl, false, bl2, string, new FilenameURL(string2), f, g, h, i, j));
        this.commandThread.interrupt();
    }

    public void newSource(boolean bl, String string, URL uRL, String string2, boolean bl2, float f, float g, float h, int i, float j) {
        this.CommandQueue(new CommandObject(10, bl, false, bl2, string, new FilenameURL(uRL, string2), f, g, h, i, j));
        this.commandThread.interrupt();
    }

    public void newStreamingSource(boolean bl, String string, String string2, boolean bl2, float f, float g, float h, int i, float j) {
        this.CommandQueue(new CommandObject(10, bl, true, bl2, string, new FilenameURL(string2), f, g, h, i, j));
        this.commandThread.interrupt();
    }

    public void newStreamingSource(boolean bl, String string, URL uRL, String string2, boolean bl2, float f, float g, float h, int i, float j) {
        this.CommandQueue(new CommandObject(10, bl, true, bl2, string, new FilenameURL(uRL, string2), f, g, h, i, j));
        this.commandThread.interrupt();
    }

    public void rawDataStream(AudioFormat audioFormat, boolean bl, String string, float f, float g, float h, int i, float j) {
        this.CommandQueue(new CommandObject(11, audioFormat, bl, string, f, g, h, i, j));
        this.commandThread.interrupt();
    }

    public String quickPlay(boolean bl, String string, boolean bl2, float f, float g, float h, int i, float j) {
        String string2 = "Source_" + this.randomNumberGenerator.nextInt() + "_" + this.randomNumberGenerator.nextInt();
        this.CommandQueue(new CommandObject(12, bl, false, bl2, string2, new FilenameURL(string), f, g, h, i, j, true));
        this.CommandQueue(new CommandObject(21, string2));
        this.commandThread.interrupt();
        return string2;
    }

    public String quickPlay(boolean bl, URL uRL, String string, boolean bl2, float f, float g, float h, int i, float j) {
        String string2 = "Source_" + this.randomNumberGenerator.nextInt() + "_" + this.randomNumberGenerator.nextInt();
        this.CommandQueue(new CommandObject(12, bl, false, bl2, string2, new FilenameURL(uRL, string), f, g, h, i, j, true));
        this.CommandQueue(new CommandObject(21, string2));
        this.commandThread.interrupt();
        return string2;
    }

    public String quickStream(boolean bl, String string, boolean bl2, float f, float g, float h, int i, float j) {
        String string2 = "Source_" + this.randomNumberGenerator.nextInt() + "_" + this.randomNumberGenerator.nextInt();
        this.CommandQueue(new CommandObject(12, bl, true, bl2, string2, new FilenameURL(string), f, g, h, i, j, true));
        this.CommandQueue(new CommandObject(21, string2));
        this.commandThread.interrupt();
        return string2;
    }

    public String quickStream(boolean bl, URL uRL, String string, boolean bl2, float f, float g, float h, int i, float j) {
        String string2 = "Source_" + this.randomNumberGenerator.nextInt() + "_" + this.randomNumberGenerator.nextInt();
        this.CommandQueue(new CommandObject(12, bl, true, bl2, string2, new FilenameURL(uRL, string), f, g, h, i, j, true));
        this.CommandQueue(new CommandObject(21, string2));
        this.commandThread.interrupt();
        return string2;
    }
    ...
    public void setPosition(String string, float f, float g, float h) {
        this.CommandQueue(new CommandObject(13, string, f, g, h));
        this.commandThread.interrupt();
    }
    ...
    public void setAttenuation(String string, int i) {
        this.CommandQueue(new CommandObject(18, string, i));
        this.commandThread.interrupt();
    }
    ...
    public void feedRawAudioData(String string, byte[] bs) {
        this.CommandQueue(new CommandObject(22, string, bs));
        this.commandThread.interrupt();
    }
    ...
    public void setTemporary(String string, boolean bl) {
        this.CommandQueue(new CommandObject(29, string, bl));
        this.commandThread.interrupt();
    }
    ...
    public void moveListener(float f, float g, float h) {
        this.CommandQueue(new CommandObject(31, f, g, h));
        this.commandThread.interrupt();
    }

    public void setListenerPosition(float f, float g, float h) {
        this.CommandQueue(new CommandObject(32, f, g, h));
        this.commandThread.interrupt();
    }

    public void turnListener(float f) {
        this.CommandQueue(new CommandObject(33, f));
        this.commandThread.interrupt();
    }

    public void setListenerAngle(float f) {
        this.CommandQueue(new CommandObject(34, f));
        this.commandThread.interrupt();
    }

    public void setListenerOrientation(float f, float g, float h, float i, float j, float k) {
        this.CommandQueue(new CommandObject(35, f, g, h, i, j, k));
        this.commandThread.interrupt();
    }
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public boolean switchLibrary(Class class_) {
        Object object = SoundSystemConfig.THREAD_SYNC;
        synchronized (object) {
            SoundSystem.initialized(true, false);
            ...
            this.message("", 0);
            this.message("Switching to " + SoundSystemConfig.getLibraryTitle(class_), 0);
            this.message("(" + SoundSystemConfig.getLibraryDescription(class_) + ")", 1);
            try {
                this.soundLibrary = (Library)class_.newInstance();
            }
    ...
    public boolean newLibrary(Class class_) {
        SoundSystem.initialized(true, false);
        this.CommandQueue(new CommandObject(37, class_));
        this.commandThread.interrupt();
    ...
    private void CommandNewLibrary(Class class_) {
        SoundSystem.initialized(true, false);
        ...
        this.message(string + SoundSystemConfig.getLibraryTitle(class_), 0);
        this.message("(" + SoundSystemConfig.getLibraryDescription(class_) + ")", 1);
        try {
            this.soundLibrary = (Library)class_.newInstance();
        }
    ...
    private void CommandFadeOutIn(String string, FilenameURL filenameURL, long l, long m) {
        if (this.soundLibrary != null) {
            this.soundLibrary.fadeOutIn(string, filenameURL, l, m);
        } else {
    ...
    private void CommandNewSource(boolean bl, boolean bl2, boolean bl3, String string, FilenameURL filenameURL, float f, float g, float h, int i, float j) {
        if (this.soundLibrary != null) {
            if (filenameURL.getFilename().matches(".*[mM][iI][dD][iI]?$") && !SoundSystemConfig.midiCodec()) {
                ...
                this.soundLibrary.newSource(bl, bl2, bl3, string, filenameURL, f, g, h, i, j);
            }
        } else {
    ...
    private void CommandRawDataStream(AudioFormat audioFormat, boolean bl, String string, float f, float g, float h, int i, float j) {
        if (this.soundLibrary != null) {
            this.soundLibrary.rawDataStream(audioFormat, bl, string, f, g, h, i, j);
        } else {
            this.errorMessage("Variable 'soundLibrary' null in method 'CommandRawDataStream'", 0);
        }
    }

    private void CommandQuickPlay(boolean bl, boolean bl2, boolean bl3, String string, FilenameURL filenameURL, float f, float g, float h, int i, float j, boolean bl4) {
        if (this.soundLibrary != null) {
            if (filenameURL.getFilename().matches(".*[mM][iI][dD][iI]?$") && !SoundSystemConfig.midiCodec()) {
                this.soundLibrary.loadMidi(bl3, string, filenameURL);
            } else {
                this.soundLibrary.quickPlay(bl, bl2, bl3, string, filenameURL, f, g, h, i, j, bl4);
            }
        } else {
    ...
    private void CommandSetPosition(String string, float f, float g, float h) {
        if (this.soundLibrary != null) {
            this.soundLibrary.setPosition(string, f, g, h);
        } else {
    ...
    private void CommandSetAttenuation(String string, int i) {
        if (this.soundLibrary != null) {
            this.soundLibrary.setAttenuation(string, i);
        } else {
    ...
    private void CommandFeedRawAudioData(String string, byte[] bs) {
        if (this.soundLibrary != null) {
            this.soundLibrary.feedRawAudioData(string, bs);
        } else {
    ...
    private void CommandMoveListener(float f, float g, float h) {
        if (this.soundLibrary != null) {
            this.soundLibrary.moveListener(f, g, h);
        } else {
            this.errorMessage("Variable 'soundLibrary' null in method 'CommandMoveListener'", 0);
        }
    }

    private void CommandSetListenerPosition(float f, float g, float h) {
        if (this.soundLibrary != null) {
            this.soundLibrary.setListenerPosition(f, g, h);
        } else {
    ...
    private void CommandSetListenerOrientation(float f, float g, float h, float i, float j, float k) {
        if (this.soundLibrary != null) {
            this.soundLibrary.setListenerOrientation(f, g, h, i, j, k);
        } else {
    ...
    public static boolean libraryCompatible(Class class_) {
        ...
        soundSystemLogger.message("Checking if " + SoundSystemConfig.getLibraryTitle(class_) + " is compatible...", 0);
        boolean bl = SoundSystemConfig.libraryCompatible(class_);
        if (bl) {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    private static Class currentLibrary(boolean bl, Class class_) {
        Object object = SoundSystemConfig.THREAD_SYNC;
        synchronized (object) {
            if (bl) {
                currentLibrary = class_;
            }
    ...
    protected boolean errorCheck(boolean bl, String string, int i) {
        return this.logger.errorCheck(bl, this.className, string, i);
    }
