        ...
        for (n4 = y - 3 + n6; n4 <= y + n6; ++n4) {
            ...
            for (n = x - n2; n <= x + n2; ++n) {
                ...
                for (int i = z - n2; i <= z + n2; ++i) {
                    ...
                    world.setBlockWithoutNotifyingNeighbors(n, n4, i, Block.LEAVES.id, 2);
                }
            }
        }
        for (n4 = 0; n4 < n6; ++n4) {
            ...
            world.setBlockWithoutNotifyingNeighbors(x, y + n4, z, Block.LOG.id, 2);
        }
        return true;
    }
}
