 ...
 * @author mine_diver
 */
public class MessagePacket extends class_169 implements ManagedPacket<MessagePacket> {
     ...
     *
     * <p>Due to a hard limit in {@link class_169#method_804(String, DataOutputStream)},
        ...
        try {
            ...
            if (present[9]) {
                ...
                for (int i = 0; i < length * 2; i++)
                    objectsInternal[i] = method_802(in, 32767);
            }
        } catch (IOException e) {
    ...
    public void method_807(DataOutputStream out) {
        try {
            method_804(identifier.toString(), out);
            ...
            if (!absent[9]) {
                ...
                Gson gson = new Gson();
                for (Object o : objects) {
                    method_804(gson.toJson(o), out);
                    method_804(o == null ? "null" : o.getClass().getName(), out);
                }
            }
        } catch (IOException e) {
            throw new RuntimeException(e);
    ...
    public void method_808(class_240 handler) {
        BiConsumer<class_54, MessagePacket> messageListener = MessageListenerRegistry.INSTANCE.get(identifier);
