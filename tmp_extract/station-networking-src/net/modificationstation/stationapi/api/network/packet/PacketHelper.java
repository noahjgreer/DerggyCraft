...
public final class PacketHelper {
     ...
     */
    @API
    public static void send(class_169 packet) {
     ...
     */
    @API
    public static void sendTo(class_54 player, class_169 packet) {
     ...
     */
    @API
    public static void dispatchLocallyAndSendTo(class_54 player, class_169 packet) {
     ...
     */
    @API
    public static void sendToAllTracking(class_57 entity, class_169 packet) {
     ...
     */
    @API
    public static void dispatchLocallyAndToAllTracking(class_57 entity, class_169 packet) {
     ...
     * @param type the packet's class that extends {@link class_169} or a subclass of it.
     */
    @API
    public static void register(int rawId, boolean clientBound, boolean serverBound, Class<? extends class_169> type) {
