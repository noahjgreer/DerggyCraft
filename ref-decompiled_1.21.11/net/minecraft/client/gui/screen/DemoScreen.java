...
public class DemoScreen extends Screen {
	...
	protected void init() {
		...
		this.movementText = MultilineText.create(
			...
			this.styleHelp(Text.translatable("demo.help.movementMouse")),
			this.styleHelp(Text.translatable("demo.help.jump", gameOptions.jumpKey.getBoundKeyLocalizedText())),
			this.styleHelp(Text.translatable("demo.help.inventory", gameOptions.inventoryKey.getBoundKeyLocalizedText()))
		);
