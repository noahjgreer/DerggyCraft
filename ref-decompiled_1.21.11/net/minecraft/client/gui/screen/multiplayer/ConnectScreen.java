...
public class ConnectScreen extends Screen {
				...
				try {
					...
					synchronized (ConnectScreen.this) {
						...
						ConnectScreen.this.future = ClientConnection.connect(
							inetSocketAddress, NetworkingBackend.remote(client.options.shouldUseNativeTransport()), clientConnection
						);
					}
	...
	public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
		...
		context.drawCenteredTextWithShadow(this.textRenderer, this.status, this.width / 2, this.height / 2 - 50, Colors.WHITE);
	}
}
