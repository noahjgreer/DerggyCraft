...
public class NeighborUpdateDebugRenderer implements DebugRenderer.Renderer {
	...
	public void render(double cameraX, double cameraY, double cameraZ, DebugDataStore store, Frustum frustum, float tickProgress) {
		...
		store.forEachEvent(DebugSubscriptionTypes.NEIGHBOR_UPDATES, (pos, remainingTime, expiry) -> {
			...
			NeighborUpdateDebugRenderer.Update updatex = (NeighborUpdateDebugRenderer.Update)map.getOrDefault(pos, NeighborUpdateDebugRenderer.Update.EMPTY);
			map.put(pos, updatex.withAge((int)l));
		});
