		...
		for (BlockPos blockPos2 : BlockPos.iterate(blockPos.add(-6, -6, -6), blockPos.add(6, 6, 6))) {
			...
			if (!blockState.isOf(Blocks.AIR)) {
				...
				for (Box box : voxelShape.getBoundingBoxes()) {
					...
					drawFace(blockPos2, blockState, blockView, Direction.WEST, vec3d, vec3d2, -2130771968);
					drawFace(blockPos2, blockState, blockView, Direction.SOUTH, vec3d, vec3d2, -2130771968);
					drawFace(blockPos2, blockState, blockView, Direction.EAST, vec3d, vec3d2, -2130771968);
					drawFace(blockPos2, blockState, blockView, Direction.NORTH, vec3d, vec3d2, -2130771968);
					drawFace(blockPos2, blockState, blockView, Direction.DOWN, vec3d, vec3d2, -2130771968);
					drawFace(blockPos2, blockState, blockView, Direction.UP, vec3d, vec3d2, -2130771968);
				}
			}
		}
	}
