...
public class ExperienceOrbEntityRenderer extends EntityRenderer<ExperienceOrbEntity, ExperienceOrbEntityRenderState> {
	...
	public void render(
		...
		orderedRenderCommandQueue.submitCustom(matrixStack, LAYER, (matricesEntry, vertexConsumer) -> {
			vertex(vertexConsumer, matricesEntry, -0.5F, -0.25F, p, 255, r, f, j, experienceOrbEntityRenderState.light);
			vertex(vertexConsumer, matricesEntry, 0.5F, -0.25F, p, 255, r, g, j, experienceOrbEntityRenderState.light);
			vertex(vertexConsumer, matricesEntry, 0.5F, 0.75F, p, 255, r, g, h, experienceOrbEntityRenderState.light);
			vertex(vertexConsumer, matricesEntry, -0.5F, 0.75F, p, 255, r, f, h, experienceOrbEntityRenderState.light);
		});
		matrixStack.pop();
