		...
		queue.submitCustom(
			...
			(matricesEntry, vertexConsumer) -> {
				...
				for (int l = 0; l < k; l++) {
					...
					matricesEntry.rotate(quaternionf);
					...
					vertexConsumer.vertex(matricesEntry, vector3f2).color(16711935);
					vertexConsumer.vertex(matricesEntry, vector3f3).color(16711935);
					vertexConsumer.vertex(matricesEntry, vector3f).color(i);
					vertexConsumer.vertex(matricesEntry, vector3f3).color(16711935);
					vertexConsumer.vertex(matricesEntry, vector3f4).color(16711935);
					vertexConsumer.vertex(matricesEntry, vector3f).color(i);
					vertexConsumer.vertex(matricesEntry, vector3f4).color(16711935);
					vertexConsumer.vertex(matricesEntry, vector3f2).color(16711935);
				}
		...
		queue.submitCustom(
			...
			(matricesEntry, vertexConsumer) -> {
				...
				for (int n = 1; n <= 8; n++) {
					...
					float q = n / 8.0F;
					vertexConsumer.vertex(matricesEntry, k * 0.2F, l * 0.2F, 0.0F)
						.color(Colors.BLACK)
						.texture(m, h)
						.overlay(OverlayTexture.DEFAULT_UV)
						.light(light)
						.normal(matricesEntry, 0.0F, -1.0F, 0.0F);
					vertexConsumer.vertex(matricesEntry, k, l, g)
						.color(Colors.WHITE)
						.texture(m, i)
						.overlay(OverlayTexture.DEFAULT_UV)
						.light(light)
						.normal(matricesEntry, 0.0F, -1.0F, 0.0F);
					vertexConsumer.vertex(matricesEntry, o, p, g)
						.color(Colors.WHITE)
						.texture(q, i)
						.overlay(OverlayTexture.DEFAULT_UV)
						.light(light)
						.normal(matricesEntry, 0.0F, -1.0F, 0.0F);
					vertexConsumer.vertex(matricesEntry, o * 0.2F, p * 0.2F, 0.0F)
						.color(Colors.BLACK)
						.texture(q, h)
						.overlay(OverlayTexture.DEFAULT_UV)
						.light(light)
