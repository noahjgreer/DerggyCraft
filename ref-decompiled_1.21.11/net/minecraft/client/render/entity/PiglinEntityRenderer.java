	...
	public PiglinEntityRenderer(
		...
		this.addFeature(
			new ArmorFeatureRenderer<>(
				this,
				EquipmentModelData.mapToEntityModel(adultModel, ctx.getEntityModels(), PiglinEntityModel::new),
				EquipmentModelData.mapToEntityModel(babyModel, ctx.getEntityModels(), PiglinEntityModel::new),
