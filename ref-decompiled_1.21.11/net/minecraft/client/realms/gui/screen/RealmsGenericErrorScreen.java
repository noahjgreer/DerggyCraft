...
public class RealmsGenericErrorScreen extends RealmsScreen {
	...
	public RealmsGenericErrorScreen(RealmsServiceException realmsServiceException, Screen parent) {
		this(RealmsGenericErrorScreen.ErrorMessages.of(realmsServiceException), parent);
	}

	public RealmsGenericErrorScreen(Text description, Screen parent) {
		this(new RealmsGenericErrorScreen.ErrorMessages(GENERIC_ERROR_TEXT, description), parent);
	}
	...
	private RealmsGenericErrorScreen(RealmsGenericErrorScreen.ErrorMessages messages, Screen parent) {
	...
	public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
		...
		this.text.draw(Alignment.CENTER, this.width / 2, 100, 9, drawnTextConsumer);
	}
