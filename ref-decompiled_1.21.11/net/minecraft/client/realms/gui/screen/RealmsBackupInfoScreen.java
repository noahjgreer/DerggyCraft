...
public class RealmsBackupInfoScreen extends RealmsScreen {
	...
	Text getValueText(String key, String value) {
		...
		} else if (string.contains("game") && string.contains("difficulty")) {
			return this.getDifficultyText(value);
		} else {
			return (Text)(key.equals("world_type") ? this.getWorldTypeText(value) : Text.literal(value));
		}
	}
	...
	class BackupInfoListEntry extends AlwaysSelectedEntryListWidget.Entry<RealmsBackupInfoScreen.BackupInfoListEntry> {
		...
		public void render(DrawContext context, int mouseX, int mouseY, boolean hovered, float deltaTicks) {
			context.drawTextWithShadow(RealmsBackupInfoScreen.this.textRenderer, this.keyLabelText, this.getContentX(), this.getContentY(), Colors.LIGHT_GRAY);
			context.drawTextWithShadow(RealmsBackupInfoScreen.this.textRenderer, this.valueText, this.getContentX(), this.getContentY() + 12, Colors.WHITE);
		}
