...
public class ItemModelGenerator {
	...
	public final void registerWithTintedOverlay(Item item, int tint) {
		...
		this.output.accept(item, ItemModels.tinted(identifier3, new DyeTintSource(tint)));
	}
	...
	public void register() {
		...
		this.registerWithTintedOverlay(Items.LEATHER_HORSE_ARMOR, -6265536);
