...
public abstract class World implements WorldAccess, AutoCloseable, AttachmentTarget {
	...
	public boolean isInLoadLimit(BlockPos pos) {
		return !this.isOutOfHeightLimit(pos) && isChunkLoadable(pos);
	}
	...
	public abstract void updateListeners(BlockPos pos, BlockState oldState, BlockState newState, @Block.SetBlockStateFlag int flags);
	...
	public void calculateAmbientDarkness() {
		this.ambientDarkness = (int)(15.0F - this.getEnvironmentAttributes().getAttributeValue(EnvironmentAttributes.SKY_LIGHT_LEVEL_GAMEPLAY));
	}
	...
	/**
	 * Checks if entities of the given type exist in {@code box}. This has the same
	 * performance cost as {@link #collectEntitiesByType} with {@code limit} set to 1.
	 * 
	 * @see #collectEntitiesByType
	 */
