...
public class ThreeLayersFeatureSize extends FeatureSize {
	public static final MapCodec<ThreeLayersFeatureSize> CODEC = RecordCodecBuilder.mapCodec(
		instance -> instance.group(
				Codec.intRange(0, 80).fieldOf("limit").orElse(1).forGetter(size -> size.limit),
				Codec.intRange(0, 80).fieldOf("upper_limit").orElse(1).forGetter(size -> size.upperLimit),
				Codec.intRange(0, 16).fieldOf("lower_size").orElse(0).forGetter(size -> size.lowerSize),
				Codec.intRange(0, 16).fieldOf("middle_size").orElse(1).forGetter(size -> size.middleSize),
				Codec.intRange(0, 16).fieldOf("upper_size").orElse(1).forGetter(size -> size.upperSize),
				createCodec()
			)
