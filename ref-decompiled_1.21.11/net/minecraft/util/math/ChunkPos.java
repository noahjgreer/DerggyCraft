...
public class ChunkPos {
	...
	public boolean isLoadable() {
		return isLoadable(this.x, this.z);
	}

	public static boolean isLoadable(int x, int z) {
		return MathHelper.absMax(x, z) <= MAX_COORDINATE;
	}
	...
	public boolean contains(BlockPos pos) {
		return pos.getX() >= this.getStartX() && pos.getZ() >= this.getStartZ() && pos.getX() <= this.getEndX() && pos.getZ() <= this.getEndZ();
	}
	...
	public int getChebyshevDistance(int x, int z) {
		return MathHelper.getChebyshevDistance(x, z, this.x, this.z);
	}
